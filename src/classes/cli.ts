...
class Cli {
    ...
    viewAllDepartments(): void {
        this.pool.query('SELECT * FROM department', (err: Error, result: QueryResult) => {
            if (err) {
                console.log(err);
                return;
            } else if (result) {
    ...
    viewAllRoles(): void {
        this.pool.query('SELECT * FROM roles', (err: Error, result: QueryResult) => {
            if (err) {
                console.log(err);
                return;
            } else if (result) {
    ...
    viewAllEmployees(): void {
        this.pool.query('SELECT * FROM employee', (err: Error, result: QueryResult) => {
            if (err) {
                console.log(err);
                return;
            } else if (result) {
    ...
    async addDepartment(): Promise<void> {
        ...
        .then((res: any) => {
            this.pool.query('INSERT INTO department (name) VALUES ($1)', [res.departmentName], (err: Error, result: QueryResult) => {
                if (err) {
                    console.log(err);
                    return;
                } else if (result) {
    ...
    async addRole(): Promise<void> {
        ...
        .then((res: any) => {
            this.pool.query('INSERT INTO roles (title, salary, department_id) VALUES ($1, $2, $3)', [res.roleName, res.salary, res.departmentId], (err: Error, result: QueryResult) => {
                if (err) {
                    console.log(err);
                    return;
                } else if (result) {
    ...
    async addEmployee(): Promise<void> {
        ...
        .then((res: any) => {
            this.pool.query('INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ($1, $2, $3, $4)', [res.firstName, res.lastName, res.roleId, res.managerId], (err: Error, result: QueryResult) => {
                if (err) {
                    console.log(err);
                    return;
                } else if (result) {
    ...
    async updateEmployeeRole(): Promise<void> {
        ...
        .then((res: any) => {
            this.pool.query('UPDATE employee SET role_id = $1 WHERE id = $2', [res.roleId, res.employeeId], (err: Error, result: QueryResult) => {
                if (err) {
                    console.log(err);
                    return;
                } else if (result) {
